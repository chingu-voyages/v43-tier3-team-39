              ...
              <div className="container mx-auto xl:px-32">
                <div className="grid lg:grid-cols-2 gap-12 flex-col items-center">
                  <div className="mt-12 lg:mt-0 flex flex-col items-center">
                    ...
                    {/* <a class="inline-block px-7 py-3 bg-transparent text-green-700 font-medium text-sm leading-snug uppercase rounded hover:text-green-900 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Learn more</a> */}
                    {/* </div> */}
                  </div>
